...
try:
    ...
    # TODO: Switch this to a version check when a stable 3.9 is released
    raise unittest.SkipTest("zoneinfo module added in 3.9.0b2")

import test.test_zoneinfo._support as test_support  # isort:skip
